...
# TODO, exact names
def check_if_driver_installed():
    """
    Check if the driver is installed
    """
    driver_list = subprocess.run(
        ["kim-api-collections-management", "list"], capture_output=True, text=True
    )
    for line in driver_list.stdout.split("\n"):
        if "KUSP__MD" in line:
            return True
    return False
...
def install_kim_driver(collection:str = "user", installer: str = "kim-api-collections-management"):
    """
    Install the KUSP model.
...
# TODO: rename the driver and model to 11111...


def remove_kim_model(installer: str = "kim-api-collections-management"):
    """
    Install the KUSP model.
...
def remove_kim_driver(installer: str = "kim-api-collections-management"):
    """
    Install the KUSP model.
    ...
    logger.info("KUSP driver remove")
    return True
